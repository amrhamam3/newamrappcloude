...
class ViewerFragment : Fragment() {
    ...
    private lateinit var btnNesting: Button
    ...
    private fun bindViews(v: View) {
        ...
        btnNesting          = v.findViewById(R.id.btnNesting)
    ...
    private fun wireUpListeners() {
        ...
        btnNesting.setOnClickListener   { animBtn(it); (activity as? MainActivity)?.openNesting() }
    ...
    private fun switchTo2DMode() {
        ...
        displayToolbar.visibility = View.GONE   // أدوات 3D فقط في وضع DXF
        btnNesting.visibility = View.VISIBLE
    ...
    private fun switchTo3DMode() {
        ...
        btnNesting.visibility = View.GONE
        btnMeasureTool.isChecked  = false
